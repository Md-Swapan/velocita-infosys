        ...
        <div className="row">
          <div className="col-lg-6 d-flex mb-5 mb-lg-0 align-items-center justify-content-center">
            <div className="banner_content">
              ...
              <p>
                Velocita Infosys Limited is dedicated to providing top-tier
                services that drive businesses forward in the dynamic digital
                landscape. Through innovation, reliability, and
                customer-centricity, we pave the path to success, ensuring
                growth with every endeavor.
              </p>
          ...
          <div className="col-lg-6 d-flex  align-content-center justify-content-center justify-content-lg-end">
            <div className="position-relative">
              ...
              <Image
                className="bubble_three"
                src={BubbleImageThree}
                width={65}
              />
              ...
              <Image
                className="bubble_seven"
                src={BubbleImageSeven}
                width={55}
              />
            </div>
          </div>
